module.exports = {
    ...
    'Sharing - AFP': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.AfpService').to.be.present.before(1000);
    },
    'Sharing - ISCSI': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.IscsiService').to.be.present.before(1000);
    },
    'Sharing - NFS': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.NfsService').to.be.present.before(1000);
    },
    'Sharing - SMB': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.SmbService').to.be.present.before(1000);
    },
    'Sharing - WEBDAV': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.WebdavService').to.be.present.before(1000);
    }
};
