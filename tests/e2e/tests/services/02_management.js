module.exports = {
    ...
    'Management - DC': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.DcService').to.be.present.before(5000);
    },
    'Management - DYNDNS': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.DynDnsService').to.be.present.before(5000);
    },
    'Management - LLDP': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.LldpService').to.be.present.before(5000);
    },
    'Management - SNMP': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.SnmpService').to.be.present.before(5000);
    },
    'Management - SSHD': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.SshdService').to.be.present.before(5000);
    },
    'Management - UPS': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.Ups').to.be.present.before(50000);
    }
};
