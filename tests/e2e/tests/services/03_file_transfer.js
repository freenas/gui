module.exports = {
    ...
    'File Transfer - FTP': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.FtpService').to.be.present.before(1000);
    },
    'File Transfer - RSYNCD': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.RsyncdService').to.be.present.before(1000);
    },
    'File Transfer - TFTPD': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Service div.TftpdService').to.be.present.before(1000);
    }
};
