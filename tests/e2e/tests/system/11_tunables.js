module.exports = {
    'Tunables': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(2) div.Viewer .Viewer-title').text.to.equal('Tunables').before(5000);
        browser.expect.element('.CascadingListItem:nth-child(2) div.SystemSection div.Tunables').to.be.present.before(5000);
    },
    'Create a tunable': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.Tunable .Inspector-header').text.to.equal('Add a Tunable').before(5000);
    }
};
