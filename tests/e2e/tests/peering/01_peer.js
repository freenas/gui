module.exports = {
    ...
    'Create peer - freenas': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(2) div.Peer div.FreenasCredentials').to.be.present.before(5000);
    },
    'Create peer - ssh': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(2) div.Peer div.SshCredentials').to.be.present.before(5000);
    },
    'Create peer - vmware': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(2) div.Peer div.VmwareCredentials').to.be.present.before(5000);
    },
    'Create peer - amazon-s3': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(2) div.Peer div.AmazonS3Credentials').to.be.present.before(5000);
    }
};
