module.exports = {
    ...
    'Configure AD': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.DirectoryService div.WinbindService').to.be.present.before(5000);
    },
    'Configure IPA': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.DirectoryService div.FreeipaService').to.be.present.before(5000);
    },
    'Configure LDAP': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.DirectoryService div.LdapService').to.be.present.before(5000);
    },
    'Configure NIS': function(browser) {
        ...
        browser.expect.element('.CascadingListItem:nth-child(3) div.DirectoryService div.NisService').to.be.present.before(5000);
    }
};
