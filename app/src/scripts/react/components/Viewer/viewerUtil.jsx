...
viewerUtil.markSearch = function ( fullString, searchString ) {
  ...
  var searchIndex = 0;
  var splitString = [ "" ];
  var fullString = fullString.toString();
  ...
  while ( i < fullString.length ) {
    ...
    if ( searchIndex <= fullString.length ) {
      ...
      if ( strLower.substring( i, searchIndex )
...
viewerUtil.ItemIcon = React.createClass(
  ...
  , setInitialsIcon: function ( props ) {
      ...
      this.setState({
        initials  : ( initials[0] + ( initials.length > 1
        ...
        return (
          ...
          >
            <img
              ...
              src       = { "data:image/jpg;base64," + this.props.iconImage }
            />
          </div>
        );
