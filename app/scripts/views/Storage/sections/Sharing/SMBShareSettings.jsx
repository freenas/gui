...
export default class SMBShareSettings extends React.Component {

  constructor ( props ) {
    super( props );
    this.displayName = "SMB Share Settings";
  }
        ...
        <form className="form-horizontal">
          ...
          */}
          ...
          <Input
            ...
            label = "Read Only"
            wrapperClassName = "col-xs-offset-2 col-xs-10"
            checked = { this.props.properties.read_only }
            onChange = { ( e ) =>
              this.props.onUpdateShare( this.props.id
                                      , { properties:
          ...
          <Input
            ...
            label = "Guest Okay"
            wrapperClassName = "col-xs-offset-2 col-xs-10"
            checked = { this.props.properties.guest_okay }
            onChange = { ( e ) =>
              this.props.onUpdateShare( this.props.id
                                      , { properties:
                                          Object.assign( this.props.properties
                                                       , { guest_okay: e.target.checked }
                                                       )
                                        }
                                      ) }
          />
          <Input
            ...
            label = "Guest Only"
            wrapperClassName = "col-xs-offset-2 col-xs-10"
            checked = { this.props.properties.guest_only }
            onChange = { ( e ) =>
              this.props.onUpdateShare( this.props.id
                                      , { properties:
                                          Object.assign( this.props.properties
                                                       , { guest_only: e.target.checked }
                                                       )
                                        }
                                      ) }
          />
...
SMBShareSettings.propTypes =
  { properties: React.PropTypes.shape(
    { read_only: React.PropTypes.bool
    , guest_only: React.PropTypes.bool
    , guest_okay: React.PropTypes.bool
    }
  ).isRequired
