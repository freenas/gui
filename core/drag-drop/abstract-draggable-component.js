var Component = require("montage/ui/component").Component, DragDropComponentManager = require('core/drag-drop/drag-drop-component-manager').defaultDragDropComponentManager, TranslateComposer = require("montage/composer/translate-composer").TranslateComposer;
/**
    ...
    enterDocument: {
        value: function (firstTime) {
            if (firstTime) {
                ...
                if (!AbstractDraggableComponent.cssTransform) {
    ...
    draw: {
        value: function () {
            ...
            if (this._isDragging) {
                ...
                if (this.parentContainer && this._containerBoundingRect) {
                    var newPositionY = this._startPositionY + this._translateY, newPositionX = this._startPositionX + this._translateX;
                    if (newPositionY < this._containerBoundingRect.top ||
                        newPositionY > this._containerBoundingRect.top + this._containerBoundingRect.height ||
                        newPositionX < this._containerBoundingRect.left ||
