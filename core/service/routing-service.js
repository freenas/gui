...
var RoutingService = (function () {
    ...
    RoutingService.prototype.loadStorageRoutes = function () {
        ...
        crossroads.addRoute('/storage/volume/_/{volumeId}/volume-dataset/_/{datasetId*}/replication', function (volumeId, datasetId) { return _this.datasetRoute.listReplications(datasetId, _this.currentStacks.get('storage')); }, 1);
        crossroads.addRoute('/storage/volume/_/{volumeId}/volume-dataset/_/{datasetId*}/replication/create', function (volumeId, datasetId) { return _this.datasetRoute.createReplication(datasetId, _this.currentStacks.get('storage')); }, 1);
        crossroads.addRoute('/storage/volume/_/{volumeId}/volume-dataset/_/{datasetId*}/replication/_/{replicationId*}', function (volumeId, datasetId, replicationId) { return _this.datasetRoute.getReplication(replicationId, _this.currentStacks.get('storage')); }, 1);
